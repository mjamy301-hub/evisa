  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-[42px] border-default disabled:bg-[#ececec] font-semibold disabled:text-default",
        className
      )}
      {...props}
    />
