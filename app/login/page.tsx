  ...
  return (
    <>
      <section className="py-4.5 bg-[#eee]">
        <div className="max-w-screen-md lg:max-w-screen-xl px-5 mx-auto font-medium">
          <div className="px-10">
      ...
      <section className="bg-white">
        <div className="max-w-screen-md lg:max-w-screen-xl px-5 py-5 mx-auto">
          <div className="lg:px-10">
            <ul className="grid grid-cols-3 border border-primary text-center text-sm font-medium">
              <li className="bg-primary text-white cursor-pointer py-2.5 flex justify-center md:justify-start items-center gap-3 px-7">
                <CircleUserRound
                  size={30}
                  strokeWidth={1.6}
                  className="text-white"
                />
                <span className="hidden md:block">Username and password</span>
              </li>
              <li className="text-primary cursor-pointer py-2.5 flex justify-center md:justify-start items-center gap-3 px-7 border-r border-primary">
              ...
              <li className="text-primary cursor-pointer py-2.5 flex justify-center md:justify-start items-center gap-3 px-7 border-r border-primary">
                <MobileIcon />
                <span className="hidden md:block">Mobile application</span>
              </li>
            </ul>
          </div>
          <div className="bg-[#f3f9ff]">
            <div className="lg:max-w-3/7 mx-auto">
